...
setwd("/Volumes/progeria2/00_intergration/00_chromHMM_2021/S10/00_reorder/05_AB_region/02_around")
...
a<-c(paste0("WT_P3_A.compartment.w",seq(26,50,1),".bed"),
     paste0("WT_P3_B.compartment.w",seq(1,50,1),".bed"),
     paste0("WT_P3_A.compartment.w",seq(1,25,1),".bed"))
...
pheatmap(res3,
         ...
         filename =  "AB region final.2.pdf")
